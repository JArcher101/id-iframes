/*
=====================================================================
PEP UPDATE REQUEST TYPE MODULE
=====================================================================
PEP update request requires:
  ...
  const UpdatePep = {
    ...
    getData: function() {
      ...
      if (file) {
        ...
        const fileName = `pep-update-attachment-${Date.now()}-${file.name}`;
        const fileData = {
          type: 'Document',
          document: 'PEP Update Attachment',
    ...
    validate: function() {
      ...
      if (!messageInput?.value?.trim()) {
        errors.push('You must enter a PEP update message');
      }
