/*
=====================================================================
ISSUE UPDATE REQUEST TYPE MODULE
=====================================================================
Issue update request requires:
  ...
  const Update = {
    ...
    getData: function() {
      ...
      if (file) {
        ...
        const fileName = `update-attachment-${Date.now()}-${file.name}`;
        const fileData = {
          type: 'Document',
          document: 'Update Attachment',
    ...
    validate: function() {
      ...
      if (!messageInput?.value?.trim()) {
        errors.push('You must enter an issue update message');
      }
